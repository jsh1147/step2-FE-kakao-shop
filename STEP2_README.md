...
<details>
<summary>Step-2.-Week-1-과제결과</summary>
<div>

## 페이지 구성

### 회원 가입
<img alt="회원 가입" src="./readme/step2/회원가입.png" width=500px>
...
### 로그인
<img alt="로그인" src="./readme/step2/로그인.png" width=500px>
...
### GNB
<img alt="GNB_로그인" src="./readme/step2/GNB_1.png" width=500px><br />
<img alt="GNB_로그아웃" src="./readme/step2/GNB_2.png" width=500px>
...
### 전체 상품(메인)
<img alt="전체 상품" src="./readme/step2/전체상품.png" width=500px>
...
### 개별 상품
<img alt="개별 상품" src="./readme/step2/개별상품.png" width=500px>
...
### 장바구니
<img alt="장바구니" src="./readme/step2/장바구니.png" width=500px>
...
### 주문하기
<img alt="주문하기" src="./readme/step2/주문하기.png" width=500px>
...
### 주문 결과
<img alt="주문 결과" src="./readme/step2/주문결과.png" width=500px>
...
## 디렉터리 구조
<img alt="디렉터리 구조1" src="./readme/step2/디렉터리구조_1.png" width=300px>
...
<img alt="디렉터리 구조2" src="./readme/step2/디렉터리구조_2.png" width=300px>
...
명칭|형태|설명
:-:|:-:|:-:
button|<img alt="" src="./readme/step2/Button.png" width=150px>|클릭
text field|<img alt="" src="./readme/step2/TextField.png" width=200px>|문자열 입력
toggle|<img alt="" src="./readme/step2/Toggle.png" width=200px>|ON/OFF 선택
raido button|<img alt="" src="./readme/step2/RadioButton.png" width=200px>|하나만 선택
checkbox|<img alt="" src="./readme/step2/Checkbox.png" width=200px>|복수 선택
alert|<img alt="" src="./readme/step2/Alert_1.png" width=200px><br /><img alt="" src="./readme/step2/Alert_2.png" width=200px>|메시지 표시,<br />상호작용 후 종료

### 사용 UI 컴포넌트

명칭|형태|설명
:-:|:-:|:-:
toast|<img alt="" src="./readme/step2/Toast.png" width=200px>|일시적인 메시지<br />작게 하단 표시
dropdown<br />menu|<img alt="" src="./readme/step2/DropdownMenu.png" width=200px>|클릭 시 메뉴
carousel|<img alt="" src="./readme/step2/Carousel.png" width=200px>|목록 수평 회전
indicator|<img alt="" src="./readme/step2/Indicator.png" width=250px>|목록 현재 위치 
card|<img alt="" src="./readme/step2/Card.png" width=200px>|정보 모음
stepper|<img alt="" src="./readme/step2/Stepper.png" width=150px>|숫자 증감

### 추가 UI 컴포넌트

명칭|형태|설명
:-:|:-:|:-:
accordion|<img alt="" src="./readme/step2/Accordion_1.png" width=250px><br /><img alt="" src="./readme/step2/Accordion_2.png" width=250px>|토글
badge|<img alt="" src="./readme/step2/Badge.png" width=200px>|부가 설명
breadcrumb|<img alt="" src="./readme/step2/Breadcrumb.png" width=200px>|페이지 경로
...
<details>
<summary>Step-2.-Week-6-과제결과</summary>
<div>
